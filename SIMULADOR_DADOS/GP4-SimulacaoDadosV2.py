...
def main():
    ...
    nome_arquivo_s3 = f"raw/{empresa}_{datacenter}_{zona}_{servidor}_dadosBrutos.csv"
    ...
    print("Enviando para a S3")
    upload_file('simulacao_servidores.csv', bucket_name, nome_arquivo_s3)
